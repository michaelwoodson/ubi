...
/**
 * WARNING: This version of the smart contract is included for upgrade testing, changes
 * should only be made to the main UBI.sol contract.
 *
 ...
 */
contract UBIv1 is Initializable {
